    ...
    <div className="container">
      ...
      <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Answers the queries on evidence from Quran & authentic hadiths in an easy-to-understand manner</div>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Halaqas are arranged to confront the social issues in accordance with the ever changing society.</div>
          </div>
          <div className="st-height-b30 st-height-lg-b30"></div>
        </div>
        {/* <!-- .col --> */}
        <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Delivers Jumuah Khutbah every Friday throughout the country & guides the Ummah in the path of the Salaf.</div>
          </div>
          <div className="st-height-b30 st-height-lg-b30"></div>
        </div>
        {/* <!-- .col --> */}
        <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Possesses great pedagogical skills & delivers lectures in the field of Islamic Sciences on various universities.</div>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Addresses contemporary issues and crisis of the Muslim world & runs Islamic Reality Show based on Quran.</div>
          </div>
          <div className="st-height-b0 st-height-lg-b30"></div>
        </div>
        {/* <!-- .col --> */}
        <div className="col-lg-4 col-md-6">
          <div className="st-iconbox st-style1">
            ...
            <div className="st-iconbox-text">Runs through the countryside & preaches the right teachings of Islam with adequate motivation.</div>
          </div>
          <div className="st-height-b0 st-height-lg-b30"></div>
        </div>
        {/* <!-- .col --> */}
